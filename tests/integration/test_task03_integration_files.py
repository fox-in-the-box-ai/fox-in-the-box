...
class TestDockerfile(unittest.TestCase):
    ...
    def test_supervisor_and_paths_copied(self) -> None:
        ...
        # supervisord.conf is generated by install-core.sh at image build —
        # packages/integration/supervisord.conf is a reference copy only and
        # must NOT be COPYd (stale pre-generation assertion corrected).
        self.assertNotIn("COPY packages/integration/supervisord.conf", self.df)
        self.assertIn("COPY packages/install-core/install-core.sh", self.df)
...
class TestSupervisordConf(unittest.TestCase):
    ...
    def test_data_paths(self) -> None:
        ...
        self.assertIn(
            "tailscaled --state=/data/data/tailscale/tailscaled.state", self.ini
        )
