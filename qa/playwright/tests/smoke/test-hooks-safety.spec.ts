...
// v0.7.18: re-enabled. v0.7.17 added '/test/' to _SETUP_PREFIXES; this
// PR's :stable is v0.7.17, so POST /test/reset now returns JSON instead
// of being 302'd to /setup. Chicken-and-egg resolved.
